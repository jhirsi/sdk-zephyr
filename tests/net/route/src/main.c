...
static struct dummy_api route_eth_if_api = {
 ...
 */
ZTEST(route_unknown_ll_suite, test_route_unknown_ll_nbr)
{
...
ZTEST_SUITE(route_unknown_ll_suite, NULL, NULL, NULL, NULL, NULL);
